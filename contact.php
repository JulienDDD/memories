    ...
    <body style="background-color: #151231; background-size: 1520px 800px;">
        ...
        <div class="block-container" style="justify-content: center;">
            ...
            <div class="block">
                ...
                <br>
                <center>
                    <div class="circle-icon"><i class="fa-solid fa-envelope"></i></div>
        ...
        <footer style="background-color: #0c0b26;">
            ...
            <br>
            <div class="ancre">
                <a href="#top" style="color: #1e1c38; text-align: center; text-decoration: none; font-size: 3vw; padding: 0 1vw;">^</a>
            </div>
            <br>
