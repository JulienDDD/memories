...
if ($currentPage == 'games/memory/index.php'):?>
  <div class="under-header" id="top">        
    <div class="header"> 
      ...
      <a href="games/memory/index.php" class="lien" style="color:orange">Jeu</a>
...
<?php elseif ($currentPage == 'games/memory/scores.php'):?> 
  <div class="under-header" id="top">        
    <div class="header"> 
      <a href="index.php" class="lien" style="font-size: 1.5em;">The Power of memory</a>
      <div class="header-right">
...
<?php elseif ($currentPage == 'MEMORIES/login.php'):?> 
  <div class="under-header" id="top">        
    <div class="header"> 
      <a href="index.php" class="lien" style="font-size: 1.5em;">The Power of memory</a>
      <div class="header-right">
