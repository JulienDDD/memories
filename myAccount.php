...
<body style="background-color: #151231; background-size: 1520px 800px;">
    ...
    <br></br>
    <center>
        <br><h1 style="margin-top: 0px; display: block;">INSCRIPTION</h1>
    </center>
    </div>
    ...
    <main>
        ...
        <div class="block-container" style="justify-content: center;">
            <div class="block" style="width: 70%; height: 47vw;">
                ...
                <br>
                <center>
                    <div class="circle-icon"><i class="fa-solid fa-user"></i></div>
                    ...
                    <div class="container-forms">
                        <div class="passwordformcontainer">
                            <form method="POST">
                                ...
                                <br><br>
                                <center>
                                    <button type="submit" name="editpwd" style="width: 60%; height:40px; border: none;" class="espace-button">Modifier mon mot de passe</button>
                                </center>
                            </form>
                            <br><br><br><br>
                        </div>
                        ...
                        <div class="emailformcontainer">
                            <form method="POST">
                                ...
                                <br><br>
                                <center>
                                    <button type="submit" name="editmail" style="width: 60%; height:40px; border: none;" class="espace-button">Modifier mon mot de passe</button>
                                </center>
                            </form>
                        </div>
                    </div>
